...
var drawboard = document.getElementById('puta-nula'),
 ...
 if (computer) {
   if (player == computer) {
      if (checkWin(board, player)) {
        ...
        winner.innerHTML ="<h1>IZGUBIO SI!</h1>";
        }, 1400);
      return;
      } 
     }
   ...
   if (player == human) {
      if (checkWin(board, player)) {
         ...
         drawTheWinnersLine(board);  
         setTimeout(function() {
         winner.innerHTML ="<h1>POBEDIO SI!</h1>";
        }, 1000);
      return;
        } 
      }
    ...
    if (player == player1) {
      ...
      drawTheWinnersLine(board);  
      setTimeout(function() {
      winner.innerHTML ="<h1>Pobedio je igrač 1 !</h1>";
        }, 1000);
      return;
      } 
    }  else {
      if (checkWin(board, player)) {
         ...
         drawTheWinnersLine(board);  
         setTimeout(function() {
         winner.innerHTML ="<h1>Pobedio je igrač 2 !</h1>";
        }, 1000);
      return;
      } 
  ...
  if (checkBoard(board)) {
     //  console.log(cb); 
      setTimeout(function() {
       winner.innerHTML= "<h1>Nerešeno !</h1>";
       //reset();
      }, 1000);
      return;
   }
